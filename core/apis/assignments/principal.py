...
def list_submitted_or_graded_assignments(p):
    """Returns list of submitted/graded assignments"""
    submitted_and_graded_assignments = Assignment.get_submitted_or_graded_assignments()
