...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        assertions.assert_found(assignment is not None,
                                'No assignment with this id was found')
    ...
    def regrade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(
            grade is not None, 'assignment with empty grade cannot be graded')
        assertions.assert_valid(assignment.state == AssignmentStateEnum.GRADED or assignment.state ==
                                AssignmentStateEnum.SUBMITTED, 'only graded/submitted assignment can be regraded')
